...
- The page starts blank: type your level, choose a class and an archetype, then Generate Build. Nothing is
  suggested until you do (the ability tree, guide builds, Build info and Score calculation tabs also wait for
  the class/archetype they need).
